...
* O front-end deverá ser feito para interagir com o back-end mas não sera avaliado, não é necessário nenhum tipo de estilização etc, apenas uma interface que consiga interagir com a API.
